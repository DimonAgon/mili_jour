...
class ScheduleTiming: #Do not try to deceive the poll
    ...
    seventh_lesson_interval = P.openclosed(datetime.time(19, 15, 0), datetime.time(23, 59, 0))
    ...
    lessons_intervals = {1: first_lesson_interval,
                         ...
                         7: seventh_lesson_interval}

    last_lesson_ordinal = 7 #configure between number and max(lesson_intervals.keys())

    @classmethod
    def lesson_intervals_match(cls, time):
